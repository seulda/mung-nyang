...
export default function BoardQna({content}) {
    console.disableYellowBox = true;

    return (
        <TouchableOpacity style={styles.oneBoard} >
            <Text style={styles.boardTitle} numberOfLines={1}>{content.title}</Text>
            <Text style={styles.boardSub} numberOfLines={1}>{content.sub}</Text>
        </TouchableOpacity>
    );
